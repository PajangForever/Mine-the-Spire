...
public final class ModEffects {
    ...
    public static final DeferredHolder<MobEffect, FocusBoostEffect> FOCUS_BOOST = REG.effect("focus_boost", FocusBoostEffect::new).color(0xD4B6FF).renderLevel().register();
    public static final DeferredHolder<MobEffect, PlasmaChargeEffect> PLASMA_CHARGE = REG.effect("plasma_charge", PlasmaChargeEffect::new).color(0xB875FF).renderLevel().register();
